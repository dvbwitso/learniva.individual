...
import { ConfirmResetForm } from "../../components/confirm-reset"
...
export default function ResetPasswordPage() {
  ...
  // Testimonial data
  const testimonial = {
    quote: "Getting back into my account was seamless with Learniva",
    description:
      "The password reset process was intuitive and secure. I appreciate the attention to user experience.",
