...
export default function RegisterPage() {
    ...
    const testimonial = {
        quote:
            "Joining Learniva was the best decision for my career growth",
        description:
            "The platform's comprehensive courses and supportive community have accelerated my learning beyond expectations.",
        author: "Alex Chen",
    };
